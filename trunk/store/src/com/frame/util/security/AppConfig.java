...
//		String configFile="E:/projects/dx/WebRoot/config/appconfig.xml";
//		String configFile1="E:/projects/dx/WebRoot/config/appconfig1.xml";
	...
	private void processInitInfor(Document doc){
		...
		if(null!=sendurlElt)
			this.sendUrl=sendurlElt.getTextTrim();
		
//		fullurl
		Element fullurlElt=(Element)doc.selectSingleNode("/sms/fullurl");
		if(null!=fullurlElt)
			this.fullUrl=fullurlElt.getTextTrim();
		
	}
	
	
	public static AppConfig getInst(){return _inst;}
