...
public class GoodCDSService {
	public  final static String GET_SALE="sale";
	public  final static String GET_SALE_UP="saleUpdate";
	public  final static String GET_SALE_CHART="chart";
	public  final static String GET_SALE_STATUS="shopstatus";
	
	public  final static String GET_SALE_UP2="saleUpdate2";
	public  final static String GET_SALE_PARS="pars";
	...
	private static Document bulidChartData(Document doc){
		...
		bf.append("select ").append(keyName).append(",").append(valfun).append(",code")
		.append(" from ").append(tblName).append(" where ").append(where);
		Connection	con=null;
			...
			List goods=doc.selectNodes("/DATAPACKET/TABLEDATA/ROWDATA/ROW");
			 ...
			 while(it.hasNext()){
				 ...
				 if(null==good){
					 ...
					 bf.append("insert into t_sale_list(code,saledate,inprice,outprice,saleNumber) values('")
					 .append(code).append("','")
					 .append(dateStr).append("',")
					 .append(sgood.getInPrice()).append(",")
					 .append(sgood.getOutPrice()).append(",")
					 .append(num)
					 .append(")");
